...
def checksumCalc(packet):
    ...
    if isinstance(packet.payload, Message):
...
class Packet:
    ...
    def __eql__(self, other):
        return (self.seqNum == other.seqNum) and (self.ackNum == other.ackNum) and (self.checksum == other.checksum) and (self.payload == other.payload)
